    ...
    public function run()
    {
        DB::table('testimonials')->insert([
            [
                ...
                'rating' => 5,
                'location' => 'Lima, Perú',
                'date_given' => Carbon::parse('2024-01-15'),
                'is_featured' => 1,
                'is_active' => 1,
                'display_order' => 1,
            ...
            [
                ...
                'date_given' => Carbon::parse('2024-01-20'),
                'is_featured' => 1,
                'is_active' => 1,
                'display_order' => 2,
                'social_proof' => json_encode([
            ...
            [
                ...
                'rating' => 5,
                'location' => 'Cusco, Perú',
                'date_given' => Carbon::parse('2024-01-25'),
                'is_featured' => 1,
                'is_active' => 1,
                'display_order' => 3,
                'social_proof' => json_encode([
            ...
            [
                ...
                'date_given' => Carbon::parse('2024-01-30'),
                'is_featured' => 1,
                'is_active' => 1,
                'display_order' => 4,
                'social_proof' => json_encode([
            ...
            [
                ...
                'date_given' => Carbon::parse('2024-02-05'),
                'is_featured' => 0,
                'is_active' => 1,
                'display_order' => 5,
                'social_proof' => json_encode([
            ...
            [
                ...
                'rating' => 5,
                'location' => 'Piura, Perú',
                'date_given' => Carbon::parse('2024-02-10'),
                'is_featured' => 0,
                'is_active' => 1,
                'display_order' => 6,
                'social_proof' => json_encode([
            ...
            [
                ...
                'date_given' => Carbon::parse('2024-02-15'),
                'is_featured' => 0,
                'is_active' => 1,
                'display_order' => 7,
                'social_proof' => json_encode([
            ...
            [
                ...
                'date_given' => Carbon::parse('2024-02-20'),
                'is_featured' => 0,
                'is_active' => 1,
                'display_order' => 8,
                'social_proof' => json_encode([
