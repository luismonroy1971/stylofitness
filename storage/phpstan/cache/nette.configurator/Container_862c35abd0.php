<?php
// source: phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar/conf/config.neon
// source: phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar/conf/config.level8.neon
// source: C:\trabajos\stylofitness\phpstan.neon
// source: array
...
class Container_862c35abd0 extends _PHPStan_bc6352b8e\Nette\DI\Container
{
	protected $tags = [
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['C:/trabajos/stylofitness']);
	}
	...
	public function createService043(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('071'),
			[
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionAttribute.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionClass.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionClassConstant.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionFunctionAbstract.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionMethod.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionParameter.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionProperty.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\iterable.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ArrayObject.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\WeakReference.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ext-ds.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ImagickPixel.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\PDOStatement.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\date.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\ibm_db2.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\mysqli.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\zip.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\dom.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\spl.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\SplObjectStorage.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\Exception.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\arrayFunctions.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\core.stub',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\typeCheckingFunctions.stub',
			],
			['C:/trabajos/stylofitness']
		);
	}
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('081'),
			[
				'#Function [a-zA-Z0-9_]+\(\) should return [a-zA-Z0-9_\\\]+ but returns [a-zA-Z0-9_\\\]+#',
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_862c35abd0 $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'C:\trabajos\stylofitness\storage\phpstan/resultCache.php',
					...
					null,
					[
						'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionUnionType.php',
						'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionAttribute.php',
						'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\Attribute.php',
						'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionIntersectionType.php',
						'C:\trabajos\stylofitness\app\Helpers\functions.php',
						'C:\trabajos\stylofitness\app\Config\App.php',
					],
					['C:\trabajos\stylofitness\index.php', 'C:\trabajos\stylofitness\setup.php'],
					['C:\trabajos\stylofitness\app\Helpers', 'C:\trabajos\stylofitness\app\Config'],
					$fileReplacements,
					false
				);
			}
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('C:\trabajos\stylofitness\storage\phpstan/resultCache.php');
	}
	...
	public function createService066(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			'C:\trabajos\stylofitness',
			($this->getParameter('sysGetTempDir')) . '/phpstan-fixer',
			['1.1.1.2'],
			['C:/trabajos/stylofitness'],
			[
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\parametersSchema.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level8.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level7.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level6.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level5.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level4.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level3.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level2.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level1.neon',
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\conf\config.level0.neon',
				'C:\trabajos\stylofitness\phpstan.neon',
			],
			null,
			[
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionUnionType.php',
	...
	public function createService073(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'C:\trabajos\stylofitness',
			'C:\trabajos\stylofitness\storage\phpstan',
			[
				'phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar/conf/config.level8.neon',
				'C:\trabajos\stylofitness\phpstan.neon',
			],
	...
	{
		return new PHPStan\File\FileHelper('C:\trabajos\stylofitness');
	}
	...
	public function createService082(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			[
				'analyseAndScan' => [
					'C:\trabajos\stylofitness\app\Views',
					'C:\trabajos\stylofitness\tests',
					'C:\trabajos\stylofitness\vendor',
				],
				'analyse' => [],
			]
		);
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('C:\trabajos\stylofitness');
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('C:\trabajos\stylofitness\storage\phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_862c35abd0
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderAnalyse'), $this->getService('081'), ['php', 'php']);
	}


	public function createServiceFileFinderScan(): PHPStan\File\FileFinder
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderScan'), $this->getService('081'), ['php', 'php']);
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('C:\trabajos\stylofitness');
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('C:\trabajos\stylofitness');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 8,
			'paths' => ['C:\trabajos\stylofitness\app'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'mixinExcludeClasses' => [],
			'scanFiles' => ['C:\trabajos\stylofitness\index.php', 'C:\trabajos\stylofitness\setup.php'],
			'scanDirectories' => ['C:\trabajos\stylofitness\app\Helpers', 'C:\trabajos\stylofitness\app\Config'],
			'parallel' => [
				'jobSize' => 20,
			...
			'memoryLimitFile' => 'C:\trabajos\stylofitness\storage\phpstan/.memory_limit',
			'tempResultCachePath' => 'C:\trabajos\stylofitness\storage\phpstan/resultCaches',
			'resultCachePath' => 'C:\trabajos\stylofitness\storage\phpstan/resultCache.php',
			...
			'__validate' => true,
			'tmpDir' => 'C:\trabajos\stylofitness\storage\phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => 'C:\trabajos\stylofitness\storage\phpstan',
			'rootDir' => 'C:\trabajos\stylofitness\vendor\phpstan\phpstan',
			'currentWorkingDirectory' => 'C:\trabajos\stylofitness',
			...
			'composerAutoloaderProjectPaths' => ['C:/trabajos/stylofitness'],
