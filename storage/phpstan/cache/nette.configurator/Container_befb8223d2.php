...
// source: phar://C:\trabajos\stylofitness\vendor\phpstan\phpstan\phpstan.phar/conf/config.level5.neon
...
class Container_befb8223d2 extends _PHPStan_bc6352b8e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_befb8223d2 $container)
			{
	...
	public function createServiceContainer(): Container_befb8223d2
	{
		return $this;
	}
