...
if (!function_exists('log_info')) {
    function log_info($message) { write_log($message, 'info'); }
}
if (!function_exists('log_warning')) {
    function log_warning($message) { write_log($message, 'warning'); }
}
if (!function_exists('log_error')) {
    function log_error($message) { write_log($message, 'error'); }
}
if (!function_exists('log_debug')) {
    function log_debug($message) { write_log($message, 'debug'); }
}
