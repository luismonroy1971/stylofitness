<!-- SecciÃ³n de Ofertas Especiales - PRIMERA SECCIÃ“N -->
        ...
        <div class="hero-carousel" id="hero-products-carousel">
            <div class="carousel-wrapper">
                <div class="carousel-track" id="hero-track">
                    <?php $heroProducts = $featuredProducts; foreach ($heroProducts as $index => $product): ?>
                        <div class="mega-slide <?php echo $index === 0 ? 'active' : ''; ?>" data-slide="<?php echo $index; ?>">
                            ...
                            <div class="container">
                                <div class="slide-content">
                                    <!-- Columna 1: InformaciÃ³n bÃ¡sica del producto (mÃ¡s angosta) -->
                                    <div class="product-info-mega">
                                        <div class="product-category-mega animate__animated animate__fadeInLeft animate__delay-1s">
                                            <?php echo htmlspecialchars($product['category_name'] ?? 'CategorÃ­a'); ?>
                                        </div>
                                        ...
                                        <div class="price-mega animate__animated animate__fadeInLeft animate__delay-2-5s">
                                            <?php if ($product['sale_price']): ?>
                                                ...
                                                <span class="savings-mega">
                                                    Â¡Ahorras S/ <?php echo number_format($product['price'] - $product['sale_price'], 2); ?>!
                                                </span>
                                            <?php else: ?>
                                        ...
                                        <div class="countdown-timer" 
                                            ...
                                            <div class="timer-digits">
                                                <div class="timer-unit">
                                                    ...
                                                    <span class="timer-label-small">DÃAS</span>
                                                </div>
                                        ...
                                        <div class="stock-indicator">
                                            ...
                                            <span class="stock-text">
                                                <?php if ($product['stock_quantity'] > 10): ?>
                                                    âœ¨ Â¡En Stock! - MÃ¡s de <?php echo $product['stock_quantity']; ?> disponibles
                                                <?php elseif ($product['stock_quantity'] > 0): ?>
                                                    âš  Â¡Ãšltimas <?php echo $product['stock_quantity']; ?> unidades!
                                                <?php else: ?>
                                                    âŒ Agotado
                                                <?php endif; ?>
                                            </span>
            ...
            <div class="mega-indicators">
                <?php foreach ($heroProducts as $index => $product): ?>
...
<!-- Nueva SecciÃ³n Hero Configurada -->
<?php 
$heroData = $this->landingController->getHeroData();
$heroConfig = $heroData['config'];
    ...
    <div class="container">
        <div class="hero-config-content">
            <div class="hero-config-badge">
                ...
                <span>CONFIGURACIÃ“N DINÃMICA</span>
            </div>
            ...
            <h2 class="hero-config-subtitle">
                <?php echo htmlspecialchars($heroConfig['subtitle'] ?? 'Tu transformaciÃ³n comienza aquÃ­'); ?>
            </h2>
            <p class="hero-config-description">
                <?php echo htmlspecialchars($heroConfig['description'] ?? 'Descubre una nueva forma de entrenar con tecnologÃ­a de vanguardia y entrenadores expertos.'); ?>
            </p>
...
<!-- Nueva SecciÃ³n de CaracterÃ­sticas Configurada -->
<?php 
    ...
    <div class="container">
        <div class="features-hero-enhanced" data-aos="zoom-in">
            <div class="features-config-badge">
                ...
                <span>CARACTERÃSTICAS ÃšNICAS</span>
            </div>
            <h2 class="features-mega-title-new">
                <span class="title-line-1-new"><?php echo htmlspecialchars($featuresConfig['title'] ?? 'Â¿Por quÃ© elegir'); ?></span>
                <span class="title-line-2-new features-config-title">STYLOFITNESS?</span>
            </h2>
            <p class="features-mega-subtitle-new">
                <?php echo htmlspecialchars($featuresConfig['subtitle'] ?? 'Descubre lo que nos hace Ãºnicos'); ?>
            </p>
            <div class="features-stats-mini">
                ...
                <div class="mini-stat">
                    ...
                    <span class="mini-stat-label">SatisfacciÃ³n</span>
                </div>
            </div>
        </div>
                ...
                <div class="feature-card-inner">
                    ...
                    <div class="feature-content-modern">
                        ...
                        <p class="feature-description-modern">
                            Entrenamientos inteligentes diseÃ±ados con IA avanzada que se adaptan a tu progreso en tiempo real
                        </p>
                        ...
                        <div class="feature-highlights">
                            ...
                            <div class="highlight-item">
                                ...
                                <span>Ajustes AutomÃ¡ticos IA</span>
                            </div>
                            <div class="highlight-item">
            ...
            <div class="modern-feature-card" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-card-inner">
                    ...
                    <div class="feature-content-modern">
                        ...
                        <p class="feature-description-modern">
                            Suplementos y accesorios de mÃ¡xima calidad con recomendaciones inteligentes
                        </p>
                        ...
                        <div class="feature-highlights">
                            ...
                            <div class="highlight-item">
                                <i class="fas fa-shipping-fast"></i>
                                <span>EnvÃ­o Express Gratis</span>
                            </div>
                            <div class="highlight-item">
                                <i class="fas fa-shield-alt"></i>
                                <span>GarantÃ­a Total</span>
            ...
            <div class="modern-feature-card" data-aos="fade-up" data-aos-delay="400">
                <div class="feature-card-inner">
                    ...
                    <div class="feature-content-modern">
                        ...
                        <p class="feature-description-modern">
                            Monitoreo completo con mÃ©tricas avanzadas y anÃ¡lisis predictivo
                        </p>
                        ...
                        <div class="feature-highlights">
                            ...
                            <div class="highlight-item">
                                ...
                                <span>AnÃ¡lisis Predictivo</span>
                            </div>
                        </div>
                        ...
                        <div class="feature-stats">
                            <div class="stat">
                                ...
                                <span class="stat-label">MÃ©tricas</span>
                            </div>
                            <div class="stat">
...
<section class="why-choose-us-section">
    <div class="container">
        <div class="section-header text-center">
            ...
            <p class="section-subtitle">Descubre las razones que nos hacen Ãºnicos</p>
        </div>
            ...
            <?php foreach ($featuredProducts as $index => $product): ?>
                <div class="product-card-enhanced hover-lift-enhanced" data-aos="fade-up" data-aos-delay="<?php echo $index * 100; ?>">
                        ...
                        <div class="product-image-enhanced">
                            ...
                            <div class="product-overlay-enhanced">
                                <div class="product-actions-enhanced">
                                    <button class="btn-action-modern btn-quick-view" data-product-id="<?php echo $product['id']; ?>" title="Vista RÃ¡pida">
                                        <i class="fas fa-eye"></i>
                                    </button>
                    ...
                    <div class="product-info-enhanced">
                        <div class="product-category-enhanced"><?php echo htmlspecialchars($product['category_name'] ?? 'CategorÃ­a'); ?></div>
                        <h3 class="product-title-enhanced">
                            <a href="<?php echo AppHelper::getBaseUrl('store/product/' . $product['slug']); ?>">
                                <?php echo htmlspecialchars($product['name'] ?? 'Producto'); ?>
                            </a>
                        </h3>
                       <p class="product-description-enhanced"><?php echo AppHelper::safeTruncatedDescription($product['short_description'] ?? 'Descripción del producto', 10); ?></p>
                        ...
                        <div class="product-stock-enhanced">
                            ...
                            <?php elseif ($product['stock_quantity'] > 0): ?>
                                <div class="stock-indicator low-stock">
                                    ...
                                    <span>Â¡Ãšltimas <?php echo $product['stock_quantity']; ?> unidades!</span>
                                </div>
                            <?php else: ?>
...
<section class="section ultra-modern-classes-section" id="clases-grupales">
    ...
    <div class="container">
                ...
                <div class="ultra-class-card" 
                    ...
                    <div class="card-content-ultra">
                        <div class="class-icon-ultra">
                            <?php
                            // Iconos dinÃ¡micos segÃºn el tipo de clase
                            $classIcons = [
                                'HIIT' => 'fas fa-fire',
                        ...
                        <p class="class-description-ultra">
                            <?php echo htmlspecialchars($class['description'] ?? 'Entrenamiento grupal dinÃ¡mico y motivador'); ?>
                        </p>
                    ...
                    <!-- Footer de la Tarjeta con BotÃ³n de AcciÃ³n -->
                        ...
                        <?php else: ?>
                            <a href="<?php echo AppHelper::getBaseUrl('login'); ?>" class="btn-reserve-ultra">
                                <div class="btn-content">
                                    ...
                                    <span class="btn-text">Inicia SesiÃ³n para Reservar</span>
                                </div>
                                <div class="btn-glow"></div>
                                <div class="btn-ripple"></div>
                            </a>
                    ...
                    <!-- Live Indicator (si la clase estÃ¡ en vivo) -->
        ...
        <!-- SecciÃ³n de Beneficios de Clases Grupales -->
        <div class="benefits-section-ultra" data-aos="fade-up" data-aos-delay="400">
            <h3 class="benefits-title">Â¿Por quÃ© entrenar en grupo?</h3>
            <div class="benefits-grid-ultra">
                <div class="benefit-item-ultra">
                    <div class="benefit-icon">
                        <i class="fas fa-users"></i>
                    </div>
                    <h4>MotivaciÃ³n Grupal</h4>
                    <p>La energÃ­a del grupo te impulsa a superar tus lÃ­mites</p>
                </div>
                <div class="benefit-item-ultra">
                    <div class="benefit-icon">
                    ...
                    <p>MantÃ©n la consistencia con horarios fijos</p>
                </div>
                <div class="benefit-item-ultra">
                    <div class="benefit-icon">
                        <i class="fas fa-user-graduate"></i>
                    ...
                    <p>GuÃ­a profesional en cada sesiÃ³n</p>
                </div>
                <div class="benefit-item-ultra">
                    <div class="benefit-icon">
                        <i class="fas fa-heart"></i>
        ...
        <div class="ultra-cta-section" data-aos="zoom-in" data-aos-delay="500">
            <div class="cta-content-ultra">
                <h3>Â¿Listo para unirte a la experiencia grupal?</h3>
                ...
                <div class="mini-stats-ultra">
                    <div class="mini-stat">
                        ...
                        <span class="label">SatisfacciÃ³n</span>
                    </div>
                    <div class="mini-stat">
    ...
    <!-- Modal de InformaciÃ³n de Clase -->
    <div class="class-info-modal" id="classInfoModal">
        <div class="modal-overlay"></div>
        <div class="modal-content">
            <div class="modal-header">
                <h3 id="modalClassName">InformaciÃ³n de la Clase</h3>
                <button class="modal-close" id="closeModal">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="modal-body" id="modalBody">
                <!-- Contenido dinÃ¡mico de la clase -->
            </div>
        </div>
    </div>
</section>

<!-- Estilos CSS para la secciÃ³n ultra moderna -->
<style>
/* =============================================
   CLASES GRUPALES ULTRA MODERNAS
   ============================================= */
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            modalBody.innerHTML = `
                <div class="modal-class-info">
                    ...
                    <div class="modal-description">
                        <h4><i class="fas fa-info-circle"></i> DescripciÃ³n</h4>
                        <p>${description}</p>
                    </div>
                    <div class="modal-benefits">
                        ...
                        <ul>
                            ...
                            <li>Quema calorÃ­as de forma eficiente</li>
        ...
        btn.addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    this.querySelector('.btn-text').textContent = 'Â¡Reservado!';
                    ...
                    // Si la clase estÃ¡ llena, deshabilitar el botÃ³n
                ...
                // Restaurar el botÃ³n despuÃ©s de un tiempo
                setTimeout(() => {
                    if (!data.success) {
    ...
    // Estilo para la animaciÃ³n de partÃ­culas flotantes
...
<!-- SECCIÃ“N DE TESTIMONIOS ULTRA MODERNA -->
    ...
    <div class="container">
        ...
        <div class="testimonials-header-ultra">
            ...
            <p class="testimonials-subtitle-ultra">
                Historias reales de transformaciÃ³n y Ã©xito que inspiran
            </p>
            ...
            <div class="testimonials-stats-ultra">
                <div class="testimonials-stat-item">
                    ...
                    <span class="stat-label-ultra">% SatisfacciÃ³n</span>
                </div>
                <div class="testimonials-stat-item">
                    ...
                    <div class="testimonial-card-inner">
                        ...
                        <div class="testimonial-content-ultra">
                            ...
                            <blockquote class="testimonial-text-ultra">
                                <?php echo htmlspecialchars($testimonial['text'] ?? 'Las rutinas personalizadas de STYLOFITNESS me ayudaron a alcanzar mis objetivos en tiempo rÃ©cord. Â¡IncreÃ­ble transformaciÃ³n!'); ?>
                            </blockquote>
                            <div class="quote-mark-close">"</div>
                        </div>
                        
                        <!-- Footer con informaciÃ³n del cliente -->
        ...
        <div class="testimonials-cta-ultra">
            <div class="cta-content-testimonials">
                ...
                <h3 class="cta-title-ultra">Â¿Quieres ser el prÃ³ximo en compartir tu historia de Ã©xito?</h3>
                <p class="cta-subtitle-ultra">Ãšnete a miles de personas que ya transformaron su vida con StyloFitness</p>
                
                <div class="cta-buttons-testimonials">
                    <a href="<?php echo AppHelper::getBaseUrl('register'); ?>" class="btn-cta-primary-ultra">
                        <span class="btn-text">Comenzar Mi TransformaciÃ³n</span>
                        <i class="fas fa-arrow-right"></i>
                        <div class="btn-glow-ultra"></div>
                    </a>
                    
                    <a href="<?php echo AppHelper::getBaseUrl('testimonials'); ?>" class="btn-cta-secondary-ultra">
                        <span class="btn-text">Ver MÃ¡s Testimonios</span>
                        <i class="fas fa-eye"></i>
                    </a>
                </div>
                ...
                <div class="testimonials-guarantees">
                    <div class="guarantee-item-ultra">
                        ...
                        <span>GarantÃ­a de Resultados</span>
                    </div>
                    <div class="guarantee-item-ultra">
                        <i class="fas fa-headset"></i>
                        <span>Soporte 24/7</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Crear partÃ­culas interactivas
    ...
    // AnimaciÃ³n de apariciÃ³n de elementos
    ...
    // Agregar estilos para animaciones dinÃ¡micas
    ...
    console.log('âœ¨ Testimonios ultra modernos inicializados correctamente');
});
</script>
<?php endif; ?>
